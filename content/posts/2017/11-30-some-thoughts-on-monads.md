...
In our subconscious, every function when composing with `id` will produces the same function. We want this rule to applies to `magicCompose` too. Therefore, we want to see:
